...
import { PanResponder, PanResponderInstance, NativeTouchEvent } from 'react-native';
...
export function PanResponderHandler({ dispatchEvents }: PanResponderHandlerProps) {
...
export function usePanResponder(dispatchEvents: DispatchEvents): [PanResponderInstance] {
        ...
        return PanResponder.create({
            ...
            onPanResponderMove: ({ nativeEvent }) => {
                ...
                if (length === 1) {
                    ...
                    const [{ locationX: x0, locationY: y0 }, { locationX: x1, locationY: y1 }] = touches as [
                        NativeTouchEvent,
                        NativeTouchEvent,
                    ];
