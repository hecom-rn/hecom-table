...
export const getDefaultPanRNGesture = (Gesture: RNGHType['Gesture'], dispatchEvents: DispatchEvents) => {
  return Gesture.Pan()
    .runOnJS(true)
...
export const getDefaultPinchRNGesture = (Gesture: RNGHType['Gesture'], dispatchEvents: DispatchEvents) => {
...
export const getDefaultTapRNGesture = (Gesture: RNGHType['Gesture'], dispatchEvents: DispatchEvents) => {
  return Gesture.Tap()
    .runOnJS(true)
...
export function RNGestureHandler({ RNGH, dispatchEvents, gesture: gestureProp }: RNGestureHandlerProps) {
